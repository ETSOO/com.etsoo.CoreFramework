namespace com.etsoo.Localization.Chinese
{
    ...
    internal static partial class ChineseCharacters
    {
        ...
        public static Dictionary<char, ChineseCharacter> Characters10 => new(800)
        {
            ...
            ['悛'] = new()
            {
                PinYins = [new("quan", CharTone.First)]
            },
            ...
            ['逡'] = new()
            {
                PinYins = [new("qun", CharTone.First)]
            },
            ...
            ['捯'] = new()
            {
                PinYins = [new("dao", CharTone.Second)]
            },
            ...
            ['赧'] = new()
            {
                PinYins = [new("nan", CharTone.Third)]
            },
            ...
            ['埽'] = new()
            {
                PinYins = [new("sao", CharTone.Fourth)]
            },
            ...
            ['喵'] = new()
            {
                PinYins = [new("miao", CharTone.First)]
            },
            ...
            ['啷'] = new()
            {
                PinYins = [new("lang", CharTone.First)]
            },
            ...
            ['崆'] = new()
            {
                PinYins = [new("kong", CharTone.First)]
            },
            ...
            ['铳'] = new()
            {
                PinYins = [new("chong", CharTone.Fourth)]
            },
            ...
            ['窕'] = new()
            {
                PinYins = [new("tiao", CharTone.Third)]
            },
            ...
            ['裉'] = new()
            {
                PinYins = [new("ken", CharTone.Fourth)]
            },
            ...
            ['谝'] = new()
            {
                PinYins = [new("pian", CharTone.Third)]
            },
            ...
            ['琫'] = new()
            {
                PinYins = [new("beng", CharTone.Third)]
            },
            ...
            ['睄'] = new()
            {
                PinYins = [new("shao", CharTone.Third)]
            },
            ...
            ['喔'] = new()
            {
                PinYins = [new("wo", CharTone.Second)]
            },
            ...
            ['嵯'] = new()
            {
                PinYins = [new("cuo", CharTone.Second)]
            },
