namespace com.etsoo.Localization.Chinese
{
    ...
    internal static partial class ChineseCharacters
    {
        ...
        public static Dictionary<char, ChineseCharacter> Characters11 => new(800)
        {
            ...
            ['湍'] = new()
            {
                PinYins = [new("tuan", CharTone.First)]
            },
            ...
            ['摁'] = new()
            {
                PinYins = [new("en", CharTone.Fourth)]
            },
            ...
            ['搋'] = new()
            {
                PinYins = [new("chuai", CharTone.First)]
            },
            ...
            ['蓊'] = new()
            {
                PinYins = [new("weng", CharTone.Third)]
            },

            // 蒯: kuai
            ['蒯'] = new()
            {
                PinYins = [new("kuai", CharTone.Third)]
            },
            ...
            ['酩'] = new()
            {
                PinYins = [new("ming", CharTone.Third)]
            },
            ...
            ['碜'] = new()
            {
                PinYins = [new("chen", CharTone.Third)]
            },
            ...
            ['跬'] = new()
            {
                PinYins = [new("kui", CharTone.Third)]
            },
            ...
            ['嗲'] = new()
            {
                PinYins = [new("dia", CharTone.Third)]
            },
            ...
            ['嗨'] = new()
            {
                PinYins = [new("hai", CharTone.First)]
            },
            ...
            ['锛'] = new()
            {
                PinYins = [new("ben", CharTone.First)]
            },
            ...
            ['嘞'] = new()
            {
                PinYins = [new("lei", CharTone.First)]
            },
