...
{
    /// <summary>
    /// MIME types mapping, media type <=> file extension
    /// MIME 类型映射, 媒体类型 <=> 文件扩展名
    /// </summary>
    public static class MimeTypeMap
    {
        ...
        /// 尝试获取MIME类型
        /// </summary>
        /// <param name="ext">Extension, like .png</param>
        /// <returns>MIME type</returns>
        public static string? TryGetMimeType(string ext)
        {
            if (Mappings.TryGetValue(ext, out var mediaType))
            {
                return mediaType;
            }
            return null;
        ...
        public static string? TryGetExtension(string? mediaType)
        {
