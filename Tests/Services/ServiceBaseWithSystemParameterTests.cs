...
namespace Tests.Services
{
    ...
    public class ServiceBaseWithSystemParameterTests
    {
        ...
        public async Task SqlSelectJsonAsyncWithMappingTests()
        {
            ...
            // Assert
            Assert.AreEqual("[{\"id\":1001,\"name\":\"Admin 1\",\"isAdmin\":true}]", json);
        }
        ...
        public async Task SqlSelectJsonAsyncWithParametersTests()
        {
            ...
            // Assert
            Assert.AreEqual("[{\"id\":1001,\"name\":\"Admin 1\",\"userId\":1001}]", json);
        }
    }
}
